...
> 📚 **Documentation lives in the [Agent-X-Plan](https://github.com/arpayidcloud-byte/Agent-X-Plan) repository** —
> see `Documentation/` there for the full onboarding guide, installation, API
> reference, architecture, deployment, runbooks, and the production master plan.
...
> `@agent-xai`). Install from source — see `Documentation/INSTALLATION.md` in
> [Agent-X-Plan](https://github.com/arpayidcloud-byte/Agent-X-Plan).
...
- **Code:** https://github.com/arpayidcloud-byte/Agent-X
- **Documentation & Plans:** https://github.com/arpayidcloud-byte/Agent-X-Plan
- **Monitoring stack:** [`deployments/monitoring/README.md`](./deployments/monitoring/README.md)
